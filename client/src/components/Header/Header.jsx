  ...
  return (
    <header className="flex justify-between ">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" fill="#D9D7D5" width="50" height="40" viewBox="0 0 72 72">
        ...
        <span className="font-bold md:text-xl text-lg">HomeVista</span>
      </Link>
      <div className="hidden md:flex md:gap-2 md:border md:border-gray-300 md:rounded-full md:py-2 md:px-4 md:shadow md:shadow-gray-300">
        <div>Anywhere</div>
      ...
      <Link to={user?'/account/bookings':'/login'} className="flex items-center md:gap-2 gap-1 border border-gray-300 rounded-full md:py-2 md:px-4 py-1 px-2">
        {user ? 
          <div className="flex gap-2">
            <div className=" text-txt rounded-full border border-gray-400 overflow-hidden">
