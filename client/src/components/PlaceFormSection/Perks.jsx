export default function Perks({selected,onChange}) {
  ...
  return (
    <div className="flex flex-col gap-2 text-lg">
      ...
      <div className="w-full flex justify-between my-3 px-4">
        ...
        <label className="flex rounded-2xl gap-2 items-center cursor-pointer pr-1">
      ...
      <div className="w-full flex justify-between mb-3 px-4">
        ...
        <label className="flex rounded-2xl gap-2 items-center cursor-pointer pr-24">
      ...
      <div className="w-full flex justify-between px-4">
        ...
        <label className="flex rounded-2xl gap-2 items-center cursor-pointer pr-3">
