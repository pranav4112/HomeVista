export default function Perks({selected,onChange}) {
  ...
  return (
    <div className="flex flex-col gap-2 md:text-lg text-base">
      ...
      <div className="w-full flex justify-between my-3 md:px-4">
        <label className=" flex rounded-2xl gap-2 items-center cursor-pointer">
        ...
        <label className="flex rounded-2xl gap-2 items-center cursor-pointer md:pr-1">
      ...
      <div className="w-full flex justify-between mb-3 md:px-4">
        <label className="  flex rounded-2xl gap-2 items-center cursor-pointer">
        ...
        <label className="flex rounded-2xl gap-2 items-center cursor-pointer md:pr-24 pr-20">
      ...
      <div className="w-full flex justify-between md:px-4">
        ...
        <label className="flex rounded-2xl gap-2 items-center cursor-pointer md:pr-3 pr-2">
          <input type="checkbox" checked={selected.includes('private_entrance')} name="private_entrance" onChange={handleCbClick}/>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
